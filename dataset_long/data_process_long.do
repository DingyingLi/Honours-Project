...
summ tobins_q ranking profitability profitability_1 indicator_complexity indicator_external_financing ///
indicator_prime size risk indicator_dividend


eststo clear
quietly estpost summ tobins_q ranking profitability profitability_1 indicator_complexity ///
indicator_external_financing size risk risk_1 growth growth_1 indicator_dividend indicator_prime
...
eststo clear
estpost corr tobins_q ranking profitability profitability_1 size risk risk_1 growth growth_1 indicator_dividend ///
indicator_complexity indicator_external_financing, matrix listwise
esttab . using tex/corr_dataset_1.tex, unstack not noobs compress label replace

pwcorr tobins_q ranking profitability profitability_1 size risk risk_1 growth growth_1 indicator_dividend ///
indicator_complexity indicator_external_financing, sig star(.05)

xtset gicsectors
xtreg tobins_q ranking profitability size risk indicator_dividend indicator_complexity ///
indicator_external_financing indicator_prime i.datayearfiscal, fe


xtset gicsectors
xtreg profitability_1 ranking size risk indicator_dividend indicator_complexity ///
indicator_external_financing indicator_prime i.datayearfiscal, fe
